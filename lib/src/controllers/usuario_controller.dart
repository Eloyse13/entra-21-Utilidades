...
import 'package:utilidades/src/services/auth_firebase_servise.dart';

class UsuarioController {
  final AuthFirebaseServise _authService = AuthFirebaseServise();
  ...
  Future<UsuarioModel?> autenticar(String email, String senha){
    return _authService.registrarUsuario(email, senha);
  }
}